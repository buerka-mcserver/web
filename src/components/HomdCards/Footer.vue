...
<template>
  <div class="footer">
    ...
    <div class="links">
      ...
      <div class="about">
        <h3>关于</h3>
        <a href="https://github.com/buerka-mcserver">Github</a>
        <a href="https://jq.qq.com/?_wv=1027&k=QUEvnQFQ">qq群</a>
      </div>
    </div>
    <div class="icp">
      <hr />
      ...
      <div>
        <a href="https://beian.miit.gov.cn/">皖ICP备2022005044号</a>
...
.footer {
  ...
  .icp {
    ...
    hr {
      margin: 5px 0;
      border-color: rgba(241, 241, 241, 0.432);
    }
    a {
      margin: 0 3px;
    }
